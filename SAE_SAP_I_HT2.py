...
#    cursor.execute('SHOW DATABASES')
 ...
 #       print(a)
    DDL_SCRIPT_ARR = [
        'DROP DATABASE IF EXISTS HT2_SAE_SAP_Python_I;',
        'CREATE DATABASE HT2_SAE_SAP_Python_I;',
        'USE HT2_SAE_SAP_Python_I;',
    ...
    DML_Cursor = mydb.cursor()
    DML_Cursor.execute(DML_SCRIPT)
    mydb.commit()
